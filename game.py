...
for i in range(0, 9):
    image = pygame.image.load(f"/Users/aaavi/PycharmProjects/YoungWonks/png-2/Glide_00{i}.png")
    image = pygame.transform.scale(image, (95, 95))
    glideright.append(image)
    image = pygame.transform.flip(image, True, False)
    glideleft.append(image)

    image = pygame.image.load(f"/Users/aaavi/PycharmProjects/YoungWonks/png-2/Run__00{i}.png")
    image = pygame.transform.scale(image, (75, 100))
    walkright.append(image)
    image = pygame.transform.flip(image, True, False)
    walkleft.append(image)

    image = pygame.image.load(f"/Users/aaavi/PycharmProjects/YoungWonks/png-2/Jump__00{i}.png")
    image = pygame.transform.scale(image, (75, 100))
    jumpright.append(image)
    image = pygame.transform.flip(image, True, False)
    jumpleft.append(image)

    image = pygame.image.load(f"/Users/aaavi/PycharmProjects/YoungWonks/png-2/Idle__00{i}.png")
    image = pygame.transform.scale(image, (48, 96))
    idleright.append(image)
    image = pygame.transform.flip(image, True, False)
    idleleft.append(image)

    image = pygame.image.load(f"/Users/aaavi/PycharmProjects/YoungWonks/png-2/Slide__00{i}.png")
    image = pygame.transform.scale(image, (80, 80))
    slideright.append(image)
    image = pygame.transform.flip(image, True, False)
    slideleft.append(image)

    image = pygame.image.load(f"/Users/aaavi/PycharmProjects/YoungWonks/png-2/Attack__00{i}.png")
    image = pygame.transform.scale(image, (105, 105))
    attackright.append(image)
    image = pygame.transform.flip(image, True, False)
    attackleft.append(image)

    image = pygame.image.load(f"/Users/aaavi/PycharmProjects/YoungWonks/png-2/Dead__00{i}.png")
    image = pygame.transform.scale(image, (105, 105))
        ...
        if not pause:
            ...
            for i in zombies:
                if i[2] > 0:
                    ...
                    pygame.draw.rect(screen, grey, (i[0] + 10, i[1] - 15, zombiehealth/2.5, 5))
                    pygame.draw.rect(screen, white, (i[0] + 10, i[1] - 15, i[2] * .4, 5))
